...
const docTemplate = `{
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/controllers.GenerateInvitationCodesRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "返回生成的邀请码列表",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
    ...
    "definitions": {
        ...
        "controllers.GenerateInvitationCodesRequest": {
            "type": "object",
            "required": [
                "count"
            ],
